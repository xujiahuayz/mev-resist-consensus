        ...
        for tx in available_transactions:
            ...
            if tx.mev_potential > 0:
                if tx.id not in targeting_tracker:
                    ...
                    attack_tx = Transaction(tx.fee * 1.1, tx.mev_potential, participant.id, targeting=True, target_tx_id=tx.id, block_created=tx.block_created, transaction_type="b_attack")
