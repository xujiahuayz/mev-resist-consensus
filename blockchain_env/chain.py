from environment import Account, Node, Mempool, Transaction, Builder, Proposer
import copy
...
class Chain:
    ...
    def find_latest_block(self):
        """
        Find the latest block in the chain, which is the last block in the longest chain.
        """
        if not self.blocks:
